    ...
    <div class="card">
        <div class="card-body">
            <div class="flex items-center gap-3 text-[#f59e0b]">
                ...
                <span>To'lov qo'shish uchun avval <a href="{{ route('contracts.create') }}" class="underline text-[#38bdf8]">shartnoma</a> yarating.</span>
            </div>
        </div>
    </div>
    @else
    <form action="{{ route('payments.store') }}" method="POST" class="card">
        ...
        <div class="card-body space-y-4">
            ...
            <div class="flex items-center justify-between pt-4 border-t border-[rgba(56,189,248,0.08)]">
                <a href="{{ route('payments.index') }}" class="text-[#64748b] hover:text-[#e2e8f0] text-sm flex items-center gap-1">
